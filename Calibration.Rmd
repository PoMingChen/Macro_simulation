...
```{r}
Beforestatics <- c(c("kzero", "lzero", "czero", "yzero", "uzero"), c(0.3525,44.02699,2.858746,4.619825,8.15725))
Beforestatics
```
...
delta3 <- 0.04 #折舊率(解釋：)
#降税
tau_k3 <- 0.025  #(房屋稅+(工地原地)房屋稅）/2（解釋：） 
